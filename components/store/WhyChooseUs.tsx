...
const POINTS_AR = [
  {
    icone: '✦',
    titre: 'جودة فاخرة',
    corps: 'جلد صناعي عالي الجودة، تشطيبات مصنوعة بعناية وبطانة متينة تدوم طويلاً.',
  },
  {
    icone: '✦',
    titre: 'سعر في المتناول',
    corps: 'الفخامة بـ 2500 دج. جودة ممتازة دون المساس بميزانيتك.',
  },
  {
    icone: '✦',
    titre: 'توصيل سريع',
    corps: 'التوصيل إلى جميع ولايات الجزائر في غضون 3 إلى 7 أيام عمل. متابعة طلبك عبر الهاتف.',
  },
  {
    icone: '✦',
    titre: 'راضٍ أو مسترد',
    corps: 'الإرجاع مقبول خلال 7 أيام إذا لم يُستخدم المنتج. رضاك هو أولويتنا.',
  },
  {
    icone: '✦',
    titre: 'هدية مثالية',
    corps: 'تغليف أنيق متوفر عند الطلب. أهدِ شيئاً لن تنساه.',
  },
]
  ...
  return (
    ...
    >
      <div style={{ maxWidth: '480px', margin: '0 auto' }}>
        ...
        >
          {estArabe ? 'لماذا تختار CH Accessoires ؟' : 'Pourquoi choisir CH Accessoires ?'}
        </h2>
