...
const AVIS = [
  { prenom: 'Samira B.', wilaya: 'Alger', note: 5, fr: 'Qualité exceptionnelle, exactement comme sur les photos. Je suis ravie de mon achat.', ar: 'جودة استثنائية، تماماً كما في الصور. أنا سعيدة جداً بشرائي.' },
  { prenom: 'Karim M.', wilaya: 'Oran', note: 5, fr: "Cadeau parfait pour ma femme. Elle a adoré, livraison rapide et soignée.", ar: 'هدية رائعة لزوجتي. أحبتها كثيراً، التوصيل كان سريعاً ومعتنى به.' },
  { prenom: 'Fatima Z.', wilaya: 'Constantine', note: 5, fr: "Je l'utilise tous les jours depuis un mois, très solide et élégant.", ar: 'أستخدمها كل يوم منذ شهر، متينة جداً وأنيقة.' },
  { prenom: 'Amira K.', wilaya: 'Annaba', note: 4, fr: 'Très beau sac, finitions soignées. Je le recommande vivement à toutes.', ar: 'حقيبة جميلة جداً، تشطيبات رائعة. أنصح بها بشدة لجميع النساء.' },
  { prenom: 'Yacine D.', wilaya: 'Blida', note: 5, fr: "Commandé pour offrir, elle était ravie. Le sac est vraiment beau en vrai.", ar: 'طلبتها هدية، كانت مبهوجة جداً. الحقيبة جميلة حقاً في الواقع.' },
  { prenom: 'Nadia H.', wilaya: 'Sétif', note: 5, fr: 'Le coloris Burgundy est magnifique en vrai, encore plus beau que sur les photos !', ar: 'لون البورغاندي رائع في الواقع، أجمل مما توقعت. جودة ممتازة.' },
]
      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '72px' }}>
          <p style={{ fontFamily: fa, fontSize: estArabe ? '13px' : '9px', fontWeight: 500, letterSpacing: estArabe ? 0 : '0.24em', textTransform: estArabe ? 'none' : 'uppercase', color: '#C9A84C', marginBottom: '14px' }}>
            {estArabe ? 'آراء عملائنا' : 'Témoignages'}
          </p>
          <h2 style={{ fontFamily: fd, fontSize: estArabe ? '34px' : '40px', fontWeight: estArabe ? 400 : 300, letterSpacing: estArabe ? 0 : '0.03em', color: '#FAFAF7', lineHeight: 1.2 }}>
            {estArabe ? 'ما تقوله عميلاتنا' : 'Ce que disent nos clientes'}
          </h2>
          {/* Étoiles globales */}
